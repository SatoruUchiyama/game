...
//*****************************************************************************
#include <windows.h>
#include "d3dx9.h"						// ビルド時の警告対処用マクロ

#define DIRECTINPUT_VERSION (0x0800)	// 警告対処用
#include "dinput.h"						// 入力処理に必要
#include "xinput.h"						// Xinput入力に必要
...
typedef enum
{
	PLAYERINDEX_1 = 0,		// プレイヤー１
	PLAYERINDEX_2,			// プレイヤー２
	PLAYERINDEX_3,			// プレイヤー３
	PLAYERINDEX_4,			// プレイヤー４
	PLAYERINDEX_MAX
}PLAYERINDEX;
...
int GetFPS(void);
void SetNumPlayer(int nNumPlayer);		// プレイヤー数の設定
int GetNumPlayer(void);					// プレイヤー数の取得
