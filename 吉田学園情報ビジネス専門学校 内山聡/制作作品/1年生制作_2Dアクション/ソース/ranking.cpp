...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_RANKING		"data/TEXTURE/number999.png"	// 読み込むテクスチャファイル名
...
//
//	VERTEX_2D *pVtx;			//頂点情報へのポインタ
//	g_pVtxBuffRanking->Lock		//頂点バッファをロック
//	(
//		0,
//		0,
//		(void**)&pVtx,
...
//	{
//		if (g_nRanking[nCount].bUse == false)		//使用してないなら
//		{
//			g_nRanking[nCount].pos = Pos;
//			g_nRanking[nCount].fwidth = fwidth;
//			g_nRanking[nCount].Height = Height;
//			g_nRanking[nCount].bUse = true;
//			g_nRanking[0].nRanking = 6000;
//			g_nRanking[1].nRanking = 0;
//			g_nRanking[2].nRanking = 0;
//			g_nRanking[3].nRanking = 0;
//			nPos = Pos;
//
//			for (nCountRanking = 0; nCountRanking < 4; nCountRanking++)
//			{
//				//頂点設定
//				pVtx[nCountRanking * 4].pos = D3DXVECTOR3(nPos.x, nPos.y, 0.0f);
//				pVtx[nCountRanking * 4 + 1].pos = D3DXVECTOR3(nPos.x + g_nRanking[nCount].fwidth, nPos.y, 0.0f);
//				pVtx[nCountRanking * 4 + 2].pos = D3DXVECTOR3(nPos.x, nPos.y + g_nRanking[nCount].Height, 0.0f);
//				pVtx[nCountRanking * 4 + 3].pos = D3DXVECTOR3(nPos.x + g_nRanking[nCount].fwidth, nPos.y + g_nRanking[nCount].Height, 0.0f);
//
//				nPos.x -= g_nRanking[nCount].fwidth;
//			}
//			break;
//		}
//		pVtx += (4 * 4);
