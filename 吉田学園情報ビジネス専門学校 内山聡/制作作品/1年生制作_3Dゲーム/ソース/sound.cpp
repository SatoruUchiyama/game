...
{
	{ "date/BGM/C+C Music Factory - Gonna Make You Sweat (Everybody Dance Now) ft. Freedom Williams.wav", -1 },		// BGM0
	{ "date/BGM/C+C Music Factory - Gonna Make You Sweat (Everybody Dance Now) ft. Freedom Williams.wav", -1 },		// BGM1
	{ "date/BGM/Dick Dale - Misirlou.wav", -1 },		// BGM2
	{ "date/SE/janpSE.wav", 0 },			// 弾発射音
	{ "date/SE/janpSE.wav", 0 },			// ヒット音0
	{ "date/SE/janpSE.wav", 0 },			// ヒット音1
	{ "date/SE/janpSE.wav", 0 },	// 爆発音
	{ "date/SE/janpSE.wav", 0 },		// 選択音
	{ "date/SE/janpSE.wav",0 },		// リザルトSE
	{ "date/SE/janpSE.wav",0 },		// 爆発　敵	
	{ "date/SE/janpSE.wav",0 },			//和風SE
	{ "date/SE/janpSE.wav", }			//決定音
};
