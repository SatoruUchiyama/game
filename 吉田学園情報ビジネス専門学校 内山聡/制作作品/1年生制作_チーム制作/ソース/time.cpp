...
void MakeVertexTime(LPDIRECT3DDEVICE9 pDevice)
{
	...
	for (nCntTime = 0; nCntTime < MAX_TIME; nCntTime++)
	{
		pVtx[0].pos = D3DXVECTOR3(570.0f + (45.0f * nCntTime), 5.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(620.0f + (45.0f * nCntTime), 5.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(570.0f + (45.0f * nCntTime), 65.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(620.0f + (45.0f * nCntTime), 65.0f, 0.0f);
