...
void InitBullet(void)
{
	...
	{//全カウントを回す
		...
		g_Bullet[nCount].nRadius = 0;
		g_Bullet[nCount].nLife = BULLET_LIFE;
...
void UpdateBullet(void)
{
	...
	{//弾をカウント
		...
		{//弾が使用されている
			...
			g_Bullet[nCntBullet].nRadius += 30;
			...
			//頂点座
			pVtx[nCntBullet * 4].pos = D3DXVECTOR3(-20.0f - g_Bullet[nCntBullet].nRadius, 50.0f, 0.0f);
			pVtx[nCntBullet * 4 + 1].pos = D3DXVECTOR3(20.0f + g_Bullet[nCntBullet].nRadius, 50.0f, 0.0f);
			pVtx[nCntBullet * 4 + 2].pos = D3DXVECTOR3(-20.0f - g_Bullet[nCntBullet].nRadius, -50.0f, 0.0f);
			pVtx[nCntBullet * 4 + 3].pos = D3DXVECTOR3(20.0f + g_Bullet[nCntBullet].nRadius, -50.0f, 0.0f);
		}
	}
...
void SetBullet(D3DXVECTOR3 pos,D3DXVECTOR3 rot,D3DXVECTOR3 move)
{
	...
	{//全テクスチャのカウント
		if (g_Bullet[nCount].bUse == false)
		{
			...
			g_Bullet[nCount].nRadius = 0;
			g_Bullet[nCount].nLife = BULLET_LIFE;		//ライフ設定
			...
			//頂点座
			pVtx[nCount * 4].pos = D3DXVECTOR3(-20.0f, 50.0f, 0.0f);
			pVtx[nCount * 4 + 1].pos = D3DXVECTOR3(20.0f, 50.0f, 0.0f);
			pVtx[nCount * 4 + 2].pos = D3DXVECTOR3(-20.0f, -50.0f, 0.0f);
			pVtx[nCount * 4 + 3].pos = D3DXVECTOR3(20.0f, -50.0f, 0.0f);
			break;
		}
	}
